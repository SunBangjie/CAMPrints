...
class sum_squared_error(_Loss):  # PyTorch 0.4.1
    ...
    def forward(self, input, target):
        ...
        return torch.nn.functional.mse_loss(input, target, size_average=None, reduce=None, reduction='mean').div_(2)

# =================================================Loss_2 MSEs========================================================
class sum_squared_errors(_Loss):  # PyTorch 0.4.1
    """
    Definition: sum_squared_error = 1/2 * nn.MSELoss(reduction = 'mean')
    The backward is defined as: input-target
    """
    def __init__(self, size_average=None, reduce=None, reduction='sum'):
        super(sum_squared_errors, self).__init__(size_average, reduce, reduction)

    def forward(self, inputs, target):
        Loss_sum = 0

        for input in inputs:
            Loss_sum += F.mse_loss(input, target, size_average=None, reduce=None, reduction='sum')
